...
const DeliverComp = ({ data }) => {
  ...
  const setMealsAfterCalculating = (startDate, endDate) => {
    ...
    console.log("helo", customerOrderCount.length);
    setMeals({
        ...
        <div className="flex items-center gap-10x IconDetailContainer">
          ...
          <div className="p-20x">
            ...
            <div className="flex justify-between gap-10x flex-wrap-on-mobile">
              ...
              {/* ---Address--- */}
              <div>
                <span className="font-12">DELIVERY ADDRESS</span>
                <h6>
                  Deliver to
                  <br />
                  <span className="text-blue">
                    ...
                    ${CustomerDeliveryAddress?.CitiesAll?.city}, 
                    ${CustomerDeliveryAddress?.CitiesAll?.state}`}
                        target="_blank"
                      >
                        {CustomerDeliveryAddress?.address},&nbsp;
                        {CustomerDeliveryAddress?.CitiesAll?.city},&nbsp;
